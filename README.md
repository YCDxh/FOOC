...
> 本系统为**计算机科学与技术专业本科毕业设计作品**，实现了一个具备完整教学流程的在线教育平台，仿照中国大学MOOC核心功能设计。
...
|-------------------------|-------------------------------|
| 需求分析                | 使用UML用例图进行需求建模       |
| 系统架构设计            | 前后端分离架构+微服务设计       |
| 数据库设计              | 符合3NF的17张核心表设计        |
| 功能模块实现            | 6大核心模块完整实现             |
| 系统测试                | Postman接口测试+Junit单元测试  |
...
| 互动系统       | 课程问答（支持@回复）、五星评分体系、学习数据统计看板                      |
| 用户系统       | RBAC权限控制、学习画像生成、多终端自适应                                   |

## 技术架构
### 技术选型
| 层级        | 技术栈                                                                     |
|------------|--------------------------------------------------------------------------|
| 前端        | Vue3 + Element Plus + Video.js                                           |
| 后端        | Spring Boot 3.1 + MyBatis Plus + Spring Security                         |
| 数据库      | MySQL 8.0 + Redis缓存                                                    |
| 存储        | MinIO对象存储（替代OSS）                                                 |
| DevOps     | Docker容器化部署 + Jenkins持续集成                                       |
