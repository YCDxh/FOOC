...
public interface RecordRepository extends JpaRepository<AfterRecord, Long> {
    ...
    List<AfterRecord> findByWorkDateBetween(LocalDate startDate, LocalDate endDate);

    List<AfterRecord> findAllByWorkDateBetween(LocalDate startDate, LocalDate endDate);
